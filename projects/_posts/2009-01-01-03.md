...
[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/002.jpg)]({{ site.baseurl }}/images/projects/ideo_gs2/002.jpg){:target="_blank"}

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/003.jpg)]({{ site.baseurl }}/images/projects/ideo_gs2/003.jpg){:target="_blank"}

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/004.jpg)]({{ site.baseurl }}/images/projects/ideo_gs2/004.jpg){:target="_blank"}

#### We had calligraphy sessions on the peer at IDEO SF during lunches. 

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/005.jpg)]({{ site.baseurl }}/images/projects/ideo_gs2/005.jpg){:target="_blank"}

---

#### Sticker packs and constellations/particles were an inspiration.

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/006.svg)]({{ site.baseurl }}/images/projects/ideo_gs2/006.svg){:target="_blank"}

---

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/007.svg)]({{ site.baseurl }}/images/projects/ideo_gs2/007.svg){:target="_blank"}

---

#### Sampling of sketches for corporate and sub-brand.

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/008.svg)]({{ site.baseurl }}/images/projects/ideo_gs2/008.svg){:target="_blank"}

---

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/009.svg)]({{ site.baseurl }}/images/projects/ideo_gs2/009.svg){:target="_blank"}
...
[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/010.svg)]({{ site.baseurl }}/images/projects/ideo_gs2/010.svg){:target="_blank"}

---

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/011.svg)]({{ site.baseurl }}/images/projects/ideo_gs2/011.svg){:target="_blank"}
...
[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/015.png)]({{ site.baseurl }}/images/projects/ideo_gs2/015.png){:target="_blank"}

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/016.png)]({{ site.baseurl }}/images/projects/ideo_gs2/016.png){:target="_blank"}
...
<div class="list">
	<ul>
		<li>We recommended that the Shop logo using the ‘O’ as a container be omitted since a competitor (CJ) had just launched with something similar. </li>
		<li>We also suggested eliminating GS One since ‘Shop’ and ‘Open’ were stronger names. </li>
		<li>We took the liberty of removing ‘Echo’ from the sub-brand option in favor of ‘Neda’ and ‘Seed’ – reasoning being that they both had more Real Deal meanings.</li>
		<li>Finally, we asked for any suggestions before we took the concepts into testing.</li>
	</ul>
</div>
...
#### Quickly, I sketched out some ideas (mostly logotypes) to test with in order to keep things consistent...
...
[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/ditto_sketches.svg)]({{ site.baseurl }}/images/projects/ideo_gs2/ditto_sketches.svg){:target="_blank"}


#### ...and landed with these three – all of them prominently using ditto marks (2 dashes similar to quote marks) 
...
<div class="bg_color_none" style="padding-bottom: 0px">
<div class="large_words">
Testing
</div>
</div>
...
<div class="list">
<ul>
	<li>What we hoped to gain from testing:</li>
	<ul>
	...
	<li>What testing will NOT enable us to do:</li>
	<ul>
...
<h2>It's important to stress this upfront since testing data and/or customer feedback shouldn't dictate the outcome of creative decisions – but rather be used more as considerations when making the final decision. Side note: I always wonder how well the name "Virgin Airlines" did in testing.</h2>
...
[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/naming4.svg)]({{ site.baseurl }}/images/projects/ideo_gs2/naming4.svg){:target="_blank"}
...
[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/open_shop_bracket_example.png)]({{ site.baseurl }}/images/projects/ideo_gs2/open_shop_bracket_example.png){:target="_blank"}
...
#### For 'Ditto' I leveraged the rounded script used for one of the 'Seed' options. This had a better feel to it (wasn't a big fan of the lowwer case e's in "seed") and the geometrical outline allowed a noticable clipping of the top the tops of the t's to create the marks. 

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/seed_ditto_script_example.png)]({{ site.baseurl }}/images/projects/ideo_gs2/seed_ditto_script_example.png){:target="_blank"}
...
<div class="ditto_believes_containter">
...
#### The obvious thing to do was to make the ditto marks a seal of approval or stamp of quality. Something that could indicate that a product, company or vendor is in line with the beliefs of the client and would create transparency around the sourcing process to customers. This would give the customer a way to participate which was helped with loyalty over time.

## In a way, by shopping with them, customers were saying "ditto" too. 


[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/toms_shoes.jpg)]({{ site.baseurl }}/images/projects/ideo_gs2/toms_shoes.jpg){:target="_blank"}
...
<div class="color_logo" style="background-color: #F7B5CD;">
...
<h4 style="margin-bottom: 20px"> Once we had these nailed down, the team was mobilized. We had a long list of items to complete in order to full realize the vision we detailed in the initial pitch. This included the following... </h4>
...
<p></p>
<div class="captions2">Photoshoot / Sample Employee Photos </div>

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/shoot_coworkers.jpg)]({{ site.baseurl }}/images/projects/ideo_gs2/shoot_coworkers.jpg){:target="_blank"}


---

<p></p>
<div class="captions2">Vendor Interview / Mono </div>

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/shoot_mono.jpg)]({{ site.baseurl }}/images/projects/ideo_gs2/shoot_mono.jpg){:target="_blank"}

---

<p></p>
<div class="captions2">Photoshoot / Theme TV Segment </div>

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/shoot_cooking.jpg)]({{ site.baseurl }}/images/projects/ideo_gs2/shoot_cooking.jpg){:target="_blank"}


---

<p></p>
<div class="captions2">Application Example / Business Cards</div>

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/bc_01.jpg)]({{ site.baseurl }}/images/projects/ideo_gs2/bc_01.jpg){:target="_blank"}

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/bc_02.jpg)]({{ site.baseurl }}/images/projects/ideo_gs2/bc_02.jpg){:target="_blank"}
...
<p></p>
<div class="captions2">Application Example / Pop-Up Store</div>

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/pop_up_store.jpg)]({{ site.baseurl }}/images/projects/ideo_gs2/pop_up_store.jpg){:target="_blank"}
...
<p></p>
<div class="captions2">Guidelines / GS Shop</div>

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/guide_gs.jpg)]({{ site.baseurl }}/images/projects/ideo_gs2/guide_gs.jpg){:target="_blank"}

---

<p></p>
<div class="captions2">Guidelines / ditto</div>

[![ideo_gs2]({{ site.baseurl }}/images/projects/ideo_gs2/guide_ditto.jpg)]({{ site.baseurl }}/images/projects/ideo_gs2/guide_ditto.jpg){:target="_blank"}
