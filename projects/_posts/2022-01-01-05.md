 ...
 <div class="data_group"> 
 	...
 	<div class="data_box"> 
	    ...
	    <!--  -->
	      ...
	      <!--  -->
	                <div class="data_image">
	                    <img src="{{site.baseurl}}/images/projects/appreciate_explore/data_box/001_albert.jpg" style="margin-bottom:0px">
	                </div>
	        <!--  -->
	    ...
	    <!--  -->
	      ...
	      <!--  -->
	                <div class="data_image">
	                    <img src="{{site.baseurl}}/images/projects/appreciate_explore/data_box/002_bonnie.jpg" style="margin-bottom:0px">
	                </div>
	        <!--  -->
	                <div class="data_specs_outer">
	                    <div class="data_specs_title">
	    ...
	    <div class="data_box_inner"> 
	      ...
	      <!--  -->
	                <div class="data_image">
	                    <img src="{{site.baseurl}}/images/projects/appreciate_explore/data_box/003_linda.jpg" style="margin-bottom:0px">
	                </div>
	        <!--  -->
	                <div class="data_specs_outer">
	                    <div class="data_specs_title">
	      ...
	      <!--  -->
	                <div class="data_image">
	                    <img src="{{site.baseurl}}/images/projects/appreciate_explore/data_box/004_noriko.jpg" style="margin-bottom:0px">
	                </div>
	        <!--  -->
	                <div class="data_specs_outer">
	                    <div class="data_specs_title">
 	...
 	<div class="data_box"> 
	    ...
	    <!--  -->
	      ...
	      <!--  -->
	                <div class="data_image">
	                    <img src="{{site.baseurl}}/images/projects/appreciate_explore/data_box/005_Thuy.jpg" style="margin-bottom:0px">
	                </div>
	        <!--  -->
	                <div class="data_specs_outer">
	                    <div class="data_specs_title">
	    ...
	    <!--  -->
	      ...
	      <!--  -->
	                <div class="data_image">
	                    <img src="{{site.baseurl}}/images/projects/appreciate_explore/data_box/006_william.jpg" style="margin-bottom:0px">
	                </div>
	        <!--  -->
	                <div class="data_specs_outer">
	                    <div class="data_specs_title">
	    ...
	    <div class="data_box_inner"> 
	      ...
	      <!--  -->
	                <div class="data_image">
	                    <img src="{{site.baseurl}}/images/projects/appreciate_explore/data_box/007_shane.jpg" style="margin-bottom:0px">
	                </div>
	        <!--  -->
	                <div class="data_specs_outer">
	                    <div class="data_specs_title">
	      ...
	      <!--  -->
	                <div class="data_image">
	                    <img src="{{site.baseurl}}/images/projects/appreciate_explore/data_box/008_linda.jpg" style="margin-bottom:0px">
	                </div>
	        <!--  -->
	                <div class="data_specs_outer">
	                    <div class="data_specs_title">
...
<div class="app_container1">
	...
	<div class="app_header">
		Some Selected Highlights
			...
			<!--  -->
			<br>
				<div class="app_label_" style="margin-top: 20px">
				Albert H.
				</div>
