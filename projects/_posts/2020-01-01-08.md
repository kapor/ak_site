...
The redesign of the Matter's global navigation (GNv2) took a few iterative swings before we had solid system to work with. With about a dozen overlapping projects in progress the aim here was to provide some stability amidst all the moving parts. What we were really designing was scaffolding robust enough to handle whatever came later. 
</div>
</div>
